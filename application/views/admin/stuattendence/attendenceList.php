...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#class_id').change(function(){
            ...
            if(attendanceType == '0'){
                $("#select_criteria_1").removeClass("col-md-3");
                $("#select_criteria_2").removeClass("col-md-3");
                $("#select_criteria_3").removeClass("col-md-3");

                $("#select_criteria_1").addClass("col-md-4");
                $("#select_criteria_2").addClass("col-md-4");
                $("#select_criteria_3").addClass("col-md-4");


                $('#subject_container').hide();

            }else{
                $("#select_criteria_1").removeClass("col-md-4");
                $("#select_criteria_2").removeClass("col-md-4");
                $("#select_criteria_3").removeClass("col-md-4");

                $("#select_criteria_1").addClass("col-md-3");
                $("#select_criteria_2").addClass("col-md-3");
                $("#select_criteria_3").addClass("col-md-3");
