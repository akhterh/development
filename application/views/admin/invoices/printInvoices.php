                ...
                <div class="row">
                    <div class="col-xs-5">
                        ...
                        <address>
                            ...
                            //echo "Name: ". $invoicesDetails[0]['parents']['firstname'] . " " . $invoicesDetails[0]['parents']['lastname']; ?></strong><br>

                            <strong><?php echo $this->lang->line('father_name'); ?>:</strong> <?php echo $invoicesDetails[0]['parents']['father_name']; ?><br>
                            <?php //echo $this->lang->line('class'); ?> <?php //echo $invoicesDetails[0]['parents']['class']  . " (" . $invoicesDetails[0]['parents']['section'] . ")"; ?>
                        </address>
                    </div>
                    <div class="col-xs-3 col-sm-offset-4 text-right">
                        ...
                        <address class="text-left">
                            <strong>Date: <?php
                                ...
                                ?></strong><br/>
                            <span><strong>Invoice No:</strong> <?php echo str_pad($invoiceslist['invoice_number'], 6, "0", STR_PAD_LEFT);  ?> </span><br/>
                            ...
                            if (empty($invoicesDetails)) {
                                ...
                                foreach ($invoicesDetails as $fee_key => $feeList) {
                                    ...
                                    if($feeList['fee_groups_feetype'][0]['feetype']['type'] == "Tuition Fee"){
                                        $discount = $feeList['fee_groups_feetype'][0]['amount'] * $feeList['student_discount_fee']  / 100;
                                    }else{
                                        $discount = 0;
                                    }
                                    ...
                                    <tr  class="dark-gray">
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td> 
                                            <?php echo $feeList['students'][0]['admission_no']; ?>
                                            </td><td><?php
