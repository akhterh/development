                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/feetype/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                </div>																<div class="form-group">                                    <label for="is_tax"><?php echo $this->lang->line('is_taxable'); ?></label>                                    <input id="is_taxable" name="is_taxable" type="checkbox"  value="YES"  <?php if(isset($feetype['is_taxable']) && trim($feetype['is_taxable']) == 'YES'){ echo 'checked="checked"';}?>/>                                    <span class="text-danger"><?php echo form_error('is_taxable'); ?></span>                                </div>
