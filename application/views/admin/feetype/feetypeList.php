                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/feetype"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
								...
								<div class="form-group">                                    <label for="is_tax"><?php echo $this->lang->line('is_taxable'); ?></label>                                    <input id="is_taxable" name="is_taxable" type="checkbox"  value="YES" />                                    <span class="text-danger"><?php echo form_error('is_taxable'); ?></span>                                </div>
