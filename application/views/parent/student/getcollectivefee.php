                                                    ...
                                                    <td>
                                                        <div class="btn-group pull-right">
                                                            ...
                                                            if ($payment_method) {
                                                                ...
                                                                if ($feetype_balance > 0) {
                                                                    ?>
                                                                    <a href="<?php echo base_url() . 'parent/payment/pay/' . $fee->id . "/" . $fee_value->fee_groups_feetype_id . "/" . $students[$i]['id'] ?>" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-money"></i> Pay</a>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                    ...
                                    <?php } ?>
                                            <tr class="box box-solid total-bg">
                                                ...
                                                <td class="text text-right"><?php
                                                    ...
                                                    ?></td>
                                                <td class="text text-right">
                                                   <!-- <a href="<?php /*echo base_url() . 'parent/payment/payall' . "/" . $this->customlib->getLoggedInUserData()['id']; */?>" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-money"></i> Pay All Dues</a>-->
                                                </td>
                                            </tr>
