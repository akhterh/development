                        ...
                        if ($this->module_lib->hasActive('fees_collection')) {
                            ...
                            <li class="treeview <?php echo set_Topmenu('Fees'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    ?>
                                    <li class="<?php echo set_Submenu('parent/parents/getAllFees'); ?>" ><a href="<?php echo base_url(); ?>parent/parents/getallfees/<?php echo $parent_data['id'] ?>"><i class="fa fa-angle-double-right"></i> <?php echo "Collective Fee" ?></a></li>
                                </ul>
                            </li>
                            <?php
                        }
...
?>
                        ...
                        <?php if (true) {
                            ...
                            <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                                <a href="#">
                                    <i class="fa fa-download"></i> <span><?php echo $this->lang->line('std_book_store'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('content/assignment'); ?>"><a href="<?php echo base_url(); ?>user/BookStore/view_stock"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('std_view_book'); ?></a></li>
                                    <li class="<?php echo set_Submenu('content/studymaterial'); ?>"><a href="<?php echo base_url(); ?>user/order/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('std_view_order'); ?></a></li>
                                </ul>
                            </li>
                            <?php
                        } ?>
