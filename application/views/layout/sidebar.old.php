...
///////////////////////////////// Book Store Menu Section Start///////////////////////////////////////


    if ($this->rbac->hasPrivilegeBookStore('can_view')) {
        ?>
        <li class="treeview <?php echo set_Topmenu('store_inventory'); ?>">
            <a href="#">
            ...
            <ul class="treeview-menu">
                <?php if (true) { ?>
                    ...
                    <li class="<?php echo set_Submenu('admin/bookstore/update_stock'); ?>"><a href="<?php echo base_url(); ?>admin/bookstore/update_stock"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('update_store_stock'); ?></a></li>
