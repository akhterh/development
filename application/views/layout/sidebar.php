                                ...
                                <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('student', 'can_add')) {
                                            ...
                                            <li class="<?php echo set_Submenu('student/bulkUpdate'); ?>"><a href="<?php echo base_url(); ?>student/bulkUpdate"><i class="fa fa-angle-double-right"></i> Update Students </a></li>
...
///////////////////////////////// Book POS Menu Section Start///////////////////////////////////////


    if ($this->rbac->hasPrivilege('book_store', 'can_view')) {
        ?>
        <li class="treeview <?php echo set_Topmenu('Inventory'); ?>">
            <a href="#">
                <i class="fa fa-book"></i> <span> <?php echo $this->lang->line('store_inventory'); ?></span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
                <?php if ($this->rbac->hasPrivilege('book_store', 'can_add') || $this->rbac->hasPrivilege('book_store', 'can_edit')) { ?>
                    <li class="<?php echo set_Submenu('admin/BookStore/add_book'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/add_book"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('add_store_book'); ?></a></li>
                    <?php
                }
                ?>
                    <li class="<?php echo set_Submenu('admin/BookStore/view_stock'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/view_stock"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('store_view_stock'); ?></a></li>

            </ul>
        </li>
        <li class="treeview <?php echo set_Topmenu('store_orders'); ?>">
            <a href="#">
                <i class="fa fa-money"></i> <span> <?php echo $this->lang->line('store_orders'); ?></span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">

                <?php if($this->rbac->hasPrivilege('order','can_add')) {?>
                    <li class="<?php echo set_Submenu('admin/BookStore/place_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/place_orders"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('lpc_place_order'); ?></a></li>
                <?php }else{ ?>
                        <li class="<?php echo set_Submenu('admin/BookStore/place_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/place_orders"><i class="fa fa-angle-double-right"></i> <?php echo "Search Order By Parent"; ?></a></li>
                    <?php } ?>
                    <li class="<?php echo set_Submenu('admin/BookStore/pending_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/pending_orders"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('store_pending_orders'); ?></a></li>
                <li class="<?php echo set_Submenu('admin/BookStore/partially_completed_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/partially_completed_orders"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('store_partially_completed_orders'); ?></a></li>
                    <li class="<?php echo set_Submenu('admin/BookStore/completed_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/completed_orders"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('store_completed_orders'); ?></a></li>

                <?php if($this->rbac->hasPrivilege('order','can_edit')) {?>
                    <li class="<?php echo set_Submenu('admin/BookStore/cancelled_orders'); ?>"><a href="<?php echo base_url(); ?>admin/BookStore/cancelled_orders"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('lpc_cancel_order'); ?></a></li>
                <?php } ?>
            </ul>
        </li>
        <?php
                        ...
                        <?php if(!$this->rbac->hasPrivilege('sales_reports','can_view')) {?>
                            <li class="treeview <?php echo set_Topmenu('store_orders'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('admin/Salesreport/dailyReport'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/dailyReport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_daily_report'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/Salesreport/weeklyReport'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/weeklyReport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_weekly_report'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/Salesreport/allReports'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/allReports"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_all_report'); ?></a></li>
                                </ul>
                            </li>
                        <?php } else{ ?>
                            <li class="treeview <?php echo set_Topmenu('store_orders'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('admin/Salesreport/allDailyReport'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/allDailyReport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_daily_report'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/Salesreport/allWeeklyReport'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/allWeeklyReport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_weekly_report'); ?></a></li>
                                    <li class="<?php echo set_Submenu('admin/Salesreport/allCompleteReports'); ?>"><a href="<?php echo base_url(); ?>admin/Salesreport/allCompleteReports"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('sales_all_report'); ?></a></li>
                                </ul>
                            </li>
                        <?php } ?>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('fees_master', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/feemaster/studentfees'); ?>"><a href="<?php echo base_url(); ?>admin/feemaster/studentfees"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student_fees_group'); ?></a></li>
                                            <?php
                                        }
                                        ...
                                        if ($this->rbac->hasPrivilege('fees_discount', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/feediscount/applyIndiviualDiscount'); ?>"><a href="<?php echo base_url(); ?>admin/feediscount/applyIndiviualDiscount"><i class="fa fa-angle-double-right"></i> <?php echo "Assign Discounts" ?></a></li>
                                            <?php
                                        }
                        ...
                        if ($this->module_lib->hasActive('invoices')) {
                            if ( $this->rbac->hasPrivilege('invoices', 'can_view')) {
                                ?>
                                <li class="treeview <?php echo set_Topmenu('invoices'); ?>">
                                    <a href="#">
                                        <i class="fa fa-money"></i> <span> <?php echo $this->lang->line('invoices'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('invoices', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('admin/invoices/index'); ?>"><a href="<?php echo base_url(); ?>admin/invoices/index"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('invoices'); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    </ul>
