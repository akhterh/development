...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="<?php echo base_url(); ?>admin/BookStore/orderItemss" method="POST">
                        ...
                        <table class="table table-striped table-bordered table-hover example">
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('std_order_id'); ?></th>
                                 <th><?php echo $this->lang->line('std_placed_by'); ?></th>
                                <th><?php echo $this->lang->line('std_placed_by_std'); ?></th>
