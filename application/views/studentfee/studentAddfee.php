                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" autofocus="" class="form-control modal_amount" onchange="onChangeAmount()" id="amount" value="0"  />
                        ...
                        <div class="form-group mb0" style="display: none; visibility: hidden;">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-2 col-sm-2 ltextright">
                                    ...
                                    <label for="inputPassword3" class="row control-label"><?php echo "Discount"; ?></label>
                                </div>
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="modal_calc_discount" readonly class="form-control" value="<?php echo $fee_tax['fee_tax']; ?>">
