                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                             ...
                             <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('guardian_id'); ?></b> <a class="pull-right text-aqua"><?php echo $student['guardian_id']; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td  class="col-md-4">Mother Tongue</td>
                                                <td  class="col-md-5"><?php echo $student['mother_tongue']; ?></td>
                                            </tr>
                                            <tr>
